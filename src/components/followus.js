  ...
  return (
    <section className="videoContainer relative bg-yellow xsm:mt-20">
      ...
      {intl.locale === "es"?  (
        ...
        <Link to="https://www.instagram.com/itacate_cl/" target="_blank" className={" w-1/3"}>
          <Img  fluid={data.pic1.childImageSharp.fluid} />
        </Link>
        <Link to="https://www.instagram.com/itacate_cl/" target="_blank" className={" w-1/3 mx-4 lg:mx-8"}>
